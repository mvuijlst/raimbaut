...
# -*- coding: utf-8 -*-
"""
build_footnote_norm.py — precompute footnote-reference normalization for the
...
Consumes (all UTF-8):
  ...
  references.json       resolved back-refs, in-note order (build_references.py)
...
with io.open(os.path.join(ROOT, "footnote-norm-flags.md"), "w", encoding="utf-8") as f:
    ...
    f.write(f"Generated by `build_footnote_norm.py`. Stats: `{json.dumps(stats)}`.\n\n")
